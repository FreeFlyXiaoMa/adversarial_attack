...
flags.DEFINE_string(
    "bert_config_file", '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/bert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", 'setiment', "The name of the task to train.")

flags.DEFINE_string("vocab_file", '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/vocab.txt',
...
flags.DEFINE_string(
    "init_checkpoint", '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/bert_model.ckpt',
...
def main(_):
  ...
  processors = {
      "setiment": SetimentProcessor, #2019/11/14 add by xmxoxo
  }
