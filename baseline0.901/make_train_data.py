...
if __name__ == "__main__":
    # pair_list = parse_train_data("/E/home/mayajun/PycharmProjects/adversarial_attack/data/train_set.xml")
    # question1=[]
    # question2=[]
    # label=[]
    ...
    train=pd.read_csv('/E/home/mayajun/PycharmProjects/adversarial_attack/data/trian.csv',header=None)
    val=pd.read_csv('/E/home/mayajun/PycharmProjects/adversarial_attack/data/valid.csv',header=None)
    result=pd.concat([train,val],axis=0)
    # print(result.head())
    result.to_csv('/E/home/mayajun/PycharmProjects/adversarial_attack/baseline0.901/train_data.csv',
                                                    index=None,header=['question1','question2','label'])
