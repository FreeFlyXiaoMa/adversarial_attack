...
if __name__ == "__main__":
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='/E/home/mayajun/PycharmProjects/adversarial_attack/data', type=str,
                        # required=True,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default='bert', type=str, #required=True,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path",
                        default='/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_roberta_wwm_large_ext_pytorch/pytorch_model.bin',
                        type=str, #required=True,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(
                            ALL_MODELS))
    parser.add_argument("--task_name", default='lcqmc', type=str, #required=True,
                        help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    parser.add_argument("--output_dir",
                        default='/E/home/mayajun/PycharmProjects/adversarial_attack/lcqmc_output', type=str,
                        #required=True,
                        help="The output directory where the model predictions and checkpoints will be written.")

    ## Other parameters
    parser.add_argument("--config_name", default="/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_roberta_wwm_large_ext_pytorch/bert_config.json",
                        type=str,
                        help="Pretrained config name or path if not the same as model_name")
    parser.add_argument("--tokenizer_name", default="", type=str,
                        help="Pretrained tokenizer name or path if not the same as model_name")
    parser.add_argument("--cache_dir", default="/E/home/mayajun/PycharmProjects/adversarial_attack/caches", type=str,
    ...
    t1=time.time()
    main(args)
    print('训练模型耗时：',(time.time()-t1)/3600,'小时')