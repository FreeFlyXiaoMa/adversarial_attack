...
config_path = '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/E/home/mayajun/PycharmProjects/adversarial_attack/chinese_wwm_ext_L-12_H-768_A-12/vocab.txt'
...
test=pd.read_csv('/E/home/mayajun/PycharmProjects/adversarial_attack/data/dev_set.csv',sep='\t')
...
sub=pd.DataFrame()
sub['pred']=list(pred)
sub.to_csv('submit_predict.csv',sep='\t',header=None)
